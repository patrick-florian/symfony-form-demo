...
<div id="wrapper">
    <div id="container">
      ...
      <p> Demo Form Link </p>
      <p> Note: You can also link the Href via an annotation for simplicity I used an HREF to the static link for the demo <pre><code> href="{{ path('demo_form') }}" </code></pre> </p>
      <a href="/demoform"> Standard Demo Form (Non Ajax) </a>
      <br/>
      <a href="/demoformajax"> Ajax Demo Form </a>
